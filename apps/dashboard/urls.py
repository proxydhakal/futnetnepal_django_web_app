...
urlpatterns = [
    ...
    path('api/<str:model_key>/<int:pk>/', views.ModelDetailAPIView.as_view(), name='api_detail'),
    path('api/<str:model_key>/<int:pk>/update/', views.ModelUpdateAPIView.as_view(), name='api_update'),
    path('api/<str:model_key>/<int:pk>/delete/', views.ModelDeleteAPIView.as_view(), name='api_delete'),
